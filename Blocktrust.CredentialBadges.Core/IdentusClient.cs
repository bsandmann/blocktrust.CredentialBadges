...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    /// <remarks>
    /// Create the new credential definition class with metadata and internal JSON Schema on behalf of Cloud Agent. The credential definition will be signed by the keys of Cloud Agent and issued by the DID that corresponds to it.
    /// </remarks>
    /// <param name="body">JSON object required for the credential definition creation</param>
    /// <returns>The new credential definition class is successfully created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Create the new credential schema class with metadata and internal JSON Schema on behalf of Cloud Agent. The credential schema will be signed by the keys of Cloud Agent and issued by the DID that corresponds to it.
    /// </remarks>
    /// <param name="body">JSON object required for the credential schema creation</param>
    /// <returns>The new credential schema class is successfully created</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Publish the new version of the credential schema class with metadata and internal JSON Schema on behalf of Cloud Agent. The credential schema will be signed by the keys of Cloud Agent and issued by the DID that corresponds to it.
    /// </remarks>
    ...
    /// <returns>The credential schema class is successfully updated</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// <br/>In the Agent database, the created connection class has an initial state set to `InvitationGenerated`.
    ...
    /// <returns>The connection class was created successfully, and is returned in the response body.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// <summary>
    /// Retrieves a specific connection flow class from the Agent's database based on its unique `connectionId`.
    /// </summary>
    /// <remarks>
    /// Retrieve a specific connection flow class from the Agent's database based in its unique `connectionId`.
    ...
    /// <br/>A new connection class with state `ConnectionRequestPending` will be created in the agent database and later processed by a background job to send a connection request to the peer Agent.
    /// <br/>The created class will contain a newly generated pairwise Peer DID used for that connection.
    /// <br/>A connection request will then be sent to the peer Agent to actually establish the connection, moving the class state to `ConnectionRequestSent`, and waiting the connection response from the peer Agent.
    /// </remarks>
    ...
    /// <br/>The returned items include essential metadata such as class ID, thread ID, state, role, issued credential, and other relevant details.
    /// </remarks>
    /// <param name="offset">The number of items to skip before returning results. Default is 0 if not specified.</param>
    /// <param name="limit">The maximum number of items to return. Defaults to 100 if not specified.</param>
    ...
    /// <summary>
    /// Retrieves a specific issue credential flow class from the Agent's database based on its unique `recordId`.
    /// </summary>
    /// <remarks>
    /// Retrieves a specific issue credential flow class from the Agent's database based on its unique `recordId`.
    /// <br/>The API returns a comprehensive collection of issue credential flow records within the system, regardless of their state.
    ...
    /// <returns>The issue credential offer was successfully accepted, and the updated class is returned in the response body.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// <br/>Note that this endpoint should only be called when automatic issuance is disabled for this class (i.e. `automaticIssuance` attribute set to `false` at offer creation time).
    /// </remarks>
    /// <param name="recordId">The `recordId` uniquely identifying the issue credential flow record.</param>
    /// <returns>The issue credential request was successfully processed, and the updated class is returned in the response body.
    ...
    /// <summary>
    /// Gets an existing proof presentation class by its unique identifier. More information on the error can be found in the response body.
    /// </summary>
    /// <remarks>
    /// Returns an existing presentation class by id.
    /// </remarks>
    ...
    /// <summary>
    /// Updates the proof presentation class matching the unique identifier, with the specific action to perform.
    /// </summary>
    /// <remarks>
    ...
    /// <returns>The proof presentation class was successfully updated.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Create the new entity record. The entity class is a representation of the account in the system.
    /// </remarks>
    ...
    /// <summary>
    /// Update the entity class name by `id`
    /// </summary>
    /// <remarks>
    /// Update the entity class name by `id`
    /// </remarks>
    /// <param name="body">JSON object required for the entity name update</param>
    /// <returns>The entity class is successfully updated</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    /// <summary>
    /// Update the entity class `walletId` by `id`
    /// </summary>
    /// <remarks>
    /// Update the entity class `walletId` field by `id`
    /// </remarks>
...
public partial class AnoncredCredentialProofV1
{
    ...
    public System.Collections.Generic.ICollection<string> RequestedAttribute { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("requestedPredicate")]
    public System.Collections.Generic.ICollection<string> RequestedPredicate { get; set; }
...
public partial class AnoncredCredentialProofsV1
{
    ...
    public System.Collections.Generic.ICollection<AnoncredCredentialProofV1> CredentialProofs { get; set; }
...
public partial class AnoncredPresentationRequestV1
{
    ...
    public AnoncredNonRevokedIntervalV1 Non_revoked { get; set; }
...
public partial class AnoncredRequestedAttributeV1
{
    ...
    public System.Collections.Generic.ICollection<Map_String> Restrictions { get; set; }
...
public partial class Connection
{
    ...
    /// <summary>
    /// The unique identifier of the thread this connection class belongs to. The value will identical on both sides of the connection (inviter and invitee)
    /// </summary>
    ...
    /// <summary>
    /// The date and time the connection class was created.
    /// </summary>
    ...
    /// <summary>
    /// The date and time the connection class was last updated.
    /// </summary>
    ...
    public int MetaRetries { get; set; }
...
public partial class ConnectionsPage
{
    ...
    public System.Collections.Generic.ICollection<Connection> Contents { get; set; }
...
public partial class CreateIssueCredentialRecordRequest
{
    ...
    public System.Guid CredentialDefinitionId { get; set; }
    ...
    public bool AutomaticIssuance { get; set; }
...
public partial class CreateManagedDidRequestDocumentTemplate
{
    ...
    public System.Collections.Generic.ICollection<ManagedDIDKeyTemplate> PublicKeys { get; set; }
    ...
    public System.Collections.Generic.ICollection<string> Contexts { get; set; }
...
public partial class CreateWebhookNotification
{
    ...
    public Map_String CustomHeaders { get; set; }
...
public partial class CredentialDefinitionResponse
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    public System.DateTimeOffset Authored { get; set; }
    ...
    [System.ComponentModel.DataAnnotations.Required]
    public object KeyCorrectnessProof { get; set; }
...
public partial class CredentialDefinitionResponsePage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<CredentialDefinitionResponse> Contents { get; set; }
...
public partial class CredentialSchemaResponsePage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<CredentialSchemaResponse> Contents { get; set; }
...
public partial class CredentialSubject
{
    ...
    [System.ComponentModel.DataAnnotations.Required]
    public StatusPurpose StatusPurpose { get; set; }
...
public partial class DIDDocument
{
    ...
    public System.Collections.Generic.ICollection<VerificationMethod> VerificationMethod { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("authentication")]
    public System.Collections.Generic.ICollection<string> Authentication { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("assertionMethod")]
    public System.Collections.Generic.ICollection<string> AssertionMethod { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("keyAgreement")]
    public System.Collections.Generic.ICollection<string> KeyAgreement { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("capabilityInvocation")]
    public System.Collections.Generic.ICollection<string> CapabilityInvocation { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("capabilityDelegation")]
    public System.Collections.Generic.ICollection<string> CapabilityDelegation { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("service")]
    public System.Collections.Generic.ICollection<Service> Service { get; set; }
...
public partial class EntityResponsePage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<EntityResponse> Contents { get; set; }
...
public partial class IssueCredentialRecord
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public IssueCredentialRecordCredentialFormat CredentialFormat { get; set; }
    ...
    /// <summary>
    /// The date and time when the issue credential class was created.
    /// </summary>
    ...
    /// <summary>
    /// The date and time when the issue credential class was last updated.
    /// </summary>
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public IssueCredentialRecordRole Role { get; set; }
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public IssueCredentialRecordProtocolState ProtocolState { get; set; }
...
public partial class IssueCredentialRecordPage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<IssueCredentialRecord> Contents { get; set; }
...
public partial class ManagedDIDPage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<ManagedDID> Contents { get; set; }
...
public partial class ParameterizableVcVerification
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public VcVerification Verification { get; set; }
...
public partial class PresentationStatus
{
    ...
    /// <summary>
    /// The unique identifier of the thread this presentation class belongs to. The value will identical on both sides of the presentation flow (verifier and prover)
    /// </summary>
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public PresentationStatusRole Role { get; set; }
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public PresentationStatusStatus Status { get; set; }
    ...
    public System.Collections.Generic.ICollection<ProofRequestAux> Proofs { get; set; }
...
public partial class PresentationStatusPage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<PresentationStatus> Contents { get; set; }
...
public partial class ProofRequestAux
{
    ...
    public System.Collections.Generic.ICollection<string> TrustIssuers { get; set; }
...
public partial class RequestPresentationAction
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public RequestPresentationActionAction Action { get; set; }

    /// <summary>
    /// The unique identifier of the issue credential class - and hence VC - to use as the prover accepts the presentation request. Only applicable on the prover side when the action is `request-accept`.
    /// </summary>

    [System.Text.Json.Serialization.JsonPropertyName("proofId")]
    public System.Collections.Generic.ICollection<string> ProofId { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("anoncredPresentationRequest")]
    public AnoncredCredentialProofsV1 AnoncredPresentationRequest { get; set; }
...
public partial class RequestPresentationInput
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("anoncredPresentationRequest")]
    public AnoncredPresentationRequestV1 AnoncredPresentationRequest { get; set; }
...
public partial class UpdateManagedDIDRequest
{
    ...
    public System.Collections.Generic.ICollection<UpdateManagedDIDRequestAction> Actions { get; set; }
...
public partial class UpdateManagedDIDRequestAction
{
    ...
    public ManagedDIDKeyTemplate AddKey { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("removeKey")]
    public RemoveEntryById RemoveKey { get; set; }
    ...
    public RemoveEntryById RemoveService { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("updateService")]
    public UpdateManagedDIDServiceAction UpdateService { get; set; }

    [System.Text.Json.Serialization.JsonPropertyName("patchContext")]
    public PatchContextAction PatchContext { get; set; }
...
public partial class VcVerificationRequest
{
    ...
    public System.Collections.Generic.ICollection<ParameterizableVcVerification> Verifications { get; set; }
...
public partial class VcVerificationResponse
{
    ...
    public System.Collections.Generic.ICollection<VcVerificationResult> Result { get; set; }
...
public partial class VerificationPolicyConstraint
{
    ...
    public System.Collections.Generic.ICollection<string> TrustedIssuers { get; set; }
...
public partial class VerificationPolicyInput
{
    ...
    public System.Collections.Generic.ICollection<VerificationPolicyConstraint> Constraints { get; set; }
...
public partial class VerificationPolicyResponsePage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<VerificationPolicyResponse> Contents { get; set; }
...
public partial class WalletDetailPage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<WalletDetail> Contents { get; set; }
...
public partial class WebhookNotificationPage
{
    ...
    [System.Text.Json.Serialization.JsonPropertyName("contents")]
    public System.Collections.Generic.ICollection<WebhookNotification> Contents { get; set; }
