...
using Builder.Commands.NewDid.RegisterApiKey;
using Builder.Commands.NewDid.RegisterEntity;
using Builder.Commands.NewDid.RegisterWallet;
...
public class RegisterApiKeyHandlerTests
{
    ...
    private readonly ILogger<RegisterApiKeyHandler> _apiKeyLogger;
    ...
    public RegisterApiKeyHandlerTests()
    {
        ...
        _apiKeyLogger = serviceProvider.GetRequiredService<ILogger<RegisterApiKeyHandler>>();
    ...
    public async Task Handle_ShouldReturnSuccessMessage_WhenApiKeyIsRegisteredSuccessfully()
    {
        ...
        var apiKeyHandler = new RegisterApiKeyHandler(_httpClientFactory, _appSettings, _apiKeyLogger);
    ...
    {
        // Arrange
        var handler = new RegisterApiKeyHandler(_httpClientFactory, _appSettings, _apiKeyLogger);
